proc create_ipi_design { offsetfile design_name } {
	...
	set IR_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:IR:1.0 IR_0]
	...
	set offset_file "${bd_path}/IR_v1_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef IR_v1_0_tb_include_vh_"
	puts $fp "`define IR_v1_0_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:IR:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/IR_v1_0_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "IR_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 IR_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top IR_v1_0_tb [get_filesets sim_1]
