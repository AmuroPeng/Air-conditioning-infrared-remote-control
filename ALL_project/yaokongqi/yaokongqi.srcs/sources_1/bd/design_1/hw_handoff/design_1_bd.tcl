...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Data [ create_bd_port -dir IO Data ]
  set GPIO_O [ create_bd_port -dir O -from 4 -to 0 GPIO_O ]
...
CONFIG.PCW_GPIO_EMIO_GPIO_IO {5} CONFIG.PCW_GPIO_EMIO_GPIO_WIDTH {5} \
...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} CONFIG.PCW_WDT_WDT_IO {<Select>} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins myip_v1_0_0/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins IR_v1_0_0/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins IR_v1_0_0/s00_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins myip_v1_0_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs IR_v1_0_0/s00_axi/reg0] SEG_IR_v1_0_0_reg0
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myip_v1_0_0/s00_axi/reg0] SEG_myip_v1_0_0_reg0
